//
//  FloatLabeledWithImageTextFieldCell.m
//  Sincronize
//
...
NSString * const XLFormRowDescriptorTypeFloatLabeledWithImageEmailField = @"XLFormRowDescriptorTypeFloatLabeledWithImageEmailField";

const static CGFloat kHMargin = 15.0f;
const static CGFloat kVMargin = 8.0f;
const static CGFloat kFloatingLabelFontSize = 11.0f;

@interface FloatLabeledWithImageEmailFieldCell () <UITextFieldDelegate>
@property (nonatomic) JVFloatLabeledTextField * floatLabeledEmailField;
@end

@implementation FloatLabeledWithImageEmailFieldCell
...
+(void)load
{
    [XLFormViewController.cellClassesForRowDescriptorTypes setObject:[FloatLabeledWithImageEmailFieldCell class] forKey:XLFormRowDescriptorTypeFloatLabeledWithImageEmailField];
}
...
-(void)configure
{
    ...
    UIView *leftView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 45, self.floatLabeledEmailField.frame.size.height)];
    UIImageView *icon = [[UIImageView alloc] initWithFrame:CGRectMake(0, -15, 26, 24)];
    [icon setImage:[UIImage imageNamed:@"usuario.png"]];
    [leftView addSubview:icon];
    
    self.floatLabeledEmailField.leftView=leftView;
    self.floatLabeledEmailField.leftViewMode=UITextFieldViewModeAlways;
